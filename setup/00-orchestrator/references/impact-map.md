...
| Tratamento (você/tu) | Nenhum diretamente | — | Impacto é nas skills de produção — AUDIENCE_PROFILES já foi gerado antes deste bloco |
...
| Nova persona (nova linguagem detectada) | BRAND_VOICE.md | Vocabulário amado/proibido, espectros de tom | 🟡 Recomendado — verificar se o tom definido cobre a linguagem da nova persona |
