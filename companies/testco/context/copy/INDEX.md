...
- **Modo:** unificado
- **Perfis:** [unificado]
- **Estrutura:** artefatos na raiz de `context/copy/` (1 persona detectada, sem bifurcação B2B)

Para detalhes da sessão (status por artefato, histórico, depósito intermediário com todos os campos das sub-skills 8.1-8.7), ver [`COPY_SESSION_STATE.md`](COPY_SESSION_STATE.md).
